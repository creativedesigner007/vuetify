                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-upper-top-item">
                            <router-link to="/home-4" class="footer-logo">
                                <img src="images/logo/4-2.png" alt="Logo">
                            </router-link>
                    ...
                    <div class="col-12">
                        <div class="footer-bottom-item">
                            <div class="footer-copyright white-text">
                                ...
                                <a href="https://themeforest.net/user/codecarnival" rel="noopener" target="_blank">CodeCarnival</a></span>
                            </div>
                        </div>
                    </div>
                </div>
